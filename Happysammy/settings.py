"""
Django settings for Happysammy project.
...
WSGI_APPLICATION = 'Happysammy.wsgi.application'
...
INTERNAL_IPS = ['kela-clinic.herokuapp.com','localhost','127.0.0.1']
